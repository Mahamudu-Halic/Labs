...
const Quiz = ({questions, setHasCompleted, setScore, score}: {
    questions: Questions[],
    ...
    const handleSubmit = () => {
        ...
        return ((questionNumber < questions.length - 1) ? sessionStorage.setItem("questionNumber", String(questionNumber + 1)) : sessionStorage.setItem("hasCompleted", "true"));
    };
        ...
        <div className={"quiz"}>
            ...
            <div className={"options-container"}>
                ...
                <button
                    ...
                    onClick={answer ? questionNumber === questions.length - 1 ? handleCompleted : handleNextQuestion : handleSubmit}
                >
                    {answer
